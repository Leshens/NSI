...
int main(int argc, char** argv) {
    ...
    int Hue_Lower_Value = 27;//initial hue value(lower)//
    int Hue_Lower_Upper_Value = 101;//initial hue value(upper)//
    int Saturation_Lower_Value = 65;//initial saturation(lower)//
    int Saturation_Upper_Value = 175;//initial saturation(upper)//
    int Value_Lower = 91;//initial value (lower)//
    int Value_Upper = 202;//initial saturation(upper)//
